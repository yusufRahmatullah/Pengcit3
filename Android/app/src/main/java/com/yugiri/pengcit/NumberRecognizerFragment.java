...
/**
 * Created by gilang on 14/09/2015.
 */
public class NumberRecognizerFragment extends Fragment{
	...
	public NumberRecognizerFragment(){}

	public static NumberRecognizerFragment newInstance(){
		NumberRecognizerFragment fragment = new NumberRecognizerFragment();
		return fragment;
	}
